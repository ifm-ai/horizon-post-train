...
async def _get_supabase_client():
    if not HARBOR_SUPABASE_URL or not HARBOR_SUPABASE_PUBLISHABLE_KEY:
        raise ValueError(
            "Set HARBOR_SUPABASE_URL and HARBOR_SUPABASE_PUBLISHABLE_KEY "
            "to use the hosted registry."
        )
